...
export default function EredivisiePage() {
  ...
  useEffect(() => {
    ...
    const fetchAnalyses = async () => {
      const allAnalyses: Analyse[] = await getAnalysesByChampionnat("eredivisie");
  ...
  if (!analyses || analyses.length === 0) {
    return <p className="text-white text-center py-10">Aucune analyse disponible pour Eredivisie.</p>;
  }

  return (
    <div className="px-6 py-10 text-white">
      <h1 className="text-3xl font-bold mb-6 text-center">Eredivisie – Analyses</h1>
