...
export default function PremierLeagueAnalysesPage() {
  ...
  useEffect(() => {
    ...
    const fetchAnalyses = async () => {
      const allAnalyses = (await getAnalysesByChampionnat("premier-league")) as Analyse[];
  ...
  if (!analyses || analyses.length === 0) {
    return <p className="text-white text-center py-10">Aucune analyse disponible pour la Premier League.</p>;
  }

  return (
    <div className="px-6 py-10 text-white">
      <h1 className="text-3xl font-bold mb-6 text-center">Premier League – Analyses</h1>
