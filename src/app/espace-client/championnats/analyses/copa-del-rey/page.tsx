...
export default function CopaDelReyPage() {
  ...
  useEffect(() => {
    ...
    const fetchAnalyses = async () => {
      // ⚠️ Doit correspondre à la valeur enregistrée en BDD
      const allAnalyses: Analyse[] = await getAnalysesByChampionnat("copa-del-rey");
  ...
  if (!analyses || analyses.length === 0) {
    return (
      <p className="text-white text-center py-10">
        Aucune analyse disponible pour la Coupe du Roi.
      </p>
    );
  }
  ...
  return (
    <div className="px-6 py-10 text-white">
      <h1 className="text-3xl font-bold mb-6 text-center">Coupe du Roi – Analyses</h1>
