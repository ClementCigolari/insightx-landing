...
export default function Ligue1Page() {
  ...
  useEffect(() => {
    ...
    const fetchAnalyses = async () => {
      const allAnalyses = await getAnalysesByChampionnat("copa-de-rey");
  ...
  if (!analyses || analyses.length === 0) {
    return <p className="text-white text-center py-10">Aucune analyse disponible pour la Coupe Du Roi.</p>;
  }
