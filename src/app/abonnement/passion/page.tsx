...
export default function FormulePassion() {
  ...
  const handleCreateAccount = () => {
    ...
    if (optionEurope) {
      options.push("europe"); // seule option dispo pour Passion
    }
  
    const recapData = {
      formule: "passion", // ✅ c'est la bonne formule
      plan: selectedPlan,
    ...
    <strong>
      {
        ...
        {selectedPlan && selectedLeague && (
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg mb-8 text-center">
            ...
            <p className="text-sm text-gray-400 mt-2">Vous créerez votre espace client juste après cette étape.</p>
          </div>
        )}
